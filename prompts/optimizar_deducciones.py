    ...
    def optimizar_deducciones() -> list[base.Message]:
        return [
            base.UserMessage(
                ...
                "si tienes discapacidad (grado), familia numerosa (general o "
                "especial).\n"
                ...
                "políticos?\n"
                "7. ¿Inviertes en empresas (business angel, MAB)?\n\n"
                "Usaré `listar_deducciones_autonomicas` y "
                "`buscar_deduccion` para cruzar tu perfil con el catálogo "
                "de tu CCAA, más las deducciones estatales del motor, y te "
                "ordenaré las oportunidades por ahorro potencial."
            )
        ]
